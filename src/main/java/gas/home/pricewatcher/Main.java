...
//        List<Goods> goodsList = repository.getAll(100000);
        ...
        goodsList.forEach(goods -> {
            ...
            goods.setCostElementIndexes(goods.getCostElementIndexes());
            goods.setCostElementTagsAndClasses(goods.getCostElementTagsAndClasses());
...
//        Goods goods = repository.get(100005, 100000);
            ...
            System.out.println("Indexes " + goods.getCostElementIndexes().length());
            System.out.println("Tags " + goods.getCostElementTagsAndClasses().length());
            System.out.println();
